        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between mt-2">
            <span>
                ...
                @if ($paginator->onFirstPage())
                    <span class="relative inline-flex items-center p-1 text-sm font-medium text-gray-500 bg-white cursor-default leading-5 rounded-md select-none">
            ...
            <span>
                ...
                @if ($paginator->hasMorePages())
                    ...
                    @endif
                @else
                    <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white cursor-default leading-5 rounded-md select-none">
                    </span>
                @endif
            </span>
        </nav>
