<div>
	<div class="sm:grid sm:grid-cols-2 items-center mb-2">
		...
		<div>
            <x-spinner wire:loading wire:target="addTeamEvent" />
            <x-spinner wire:loading wire:target="saveTeamEvent" />
            <x-spinner wire:loading wire:target="cancelAddEvent" />
    ...
    <x-modal-wire.dialog wire:model.defer="showDelEvent" type="warn" maxWidth="md">
            ...
            <x-slot name="content">
                <div class="flex-col space-y-2">
                    <x-spinner wire:loading wire:target="deleteTeamEvent" />
