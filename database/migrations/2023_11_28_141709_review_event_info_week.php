    ...
    private function createView(): string
    {
        return <<<SQL
            CREATE VIEW EventInfoWeek AS
                SELECT te.id, te.title, te.day, te.start, te.end,t.id as tid, t.name, COALESCE(tu.all_user, 0) as all_u, COALESCE(visit.b_user,0) as b_u, (COALESCE(tu.all_user, 0)-COALESCE(visit.b_user,0)) as n_u, notes.last_note, cl.color, COALESCE(inf.count_note,0) as notes, COALESCE(fl.count_file,0) as files 
